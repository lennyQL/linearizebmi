...
for tc=1:6
  ...
  %      =linearizebmi3(Fstr,{'p','k','G'},{'p0','k0','G0'},'G0',t);
  switch opts.method
    case 0  % Sebe (2007)
      G0=eye(nk);
      [LMIauto,LMIstr,~,orgBMI]...
          =linearizebmi6(Fstr,{'p','k'},{'p0','k0'},'G0',t,opts);
    case 1  % Sebe (2018)
      G =sdpvar(nk,nk,'full');        % decomposition matrix
      G0=sdpvar(nk,nk,'full');        % dummy matrix
      [LMIauto,LMIstr,~,orgBMI]...
           =linearizebmi6(Fstr,{'p','k','G'},{'p0','k0','G0'},'G0',t,opts);
    ...
    case 4  % Ren el al. (2021)
      ...
      [LMIauto,LMIstr,~,orgBMI]...
           =linearizebmi6(Fstr,{'p','k','G','M'},{'p0','k0','G0','M0'},'G0',t,opts);
  end
